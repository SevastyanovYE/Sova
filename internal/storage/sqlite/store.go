...
CREATE TABLE IF NOT EXISTS workspace_publish_runs (
    ...
    manual_editor_user_id INTEGER NOT NULL DEFAULT 0,
    manual_input_message_id INTEGER NOT NULL DEFAULT 0,
    manual_replacement_run_id INTEGER NOT NULL DEFAULT 0,
    last_error TEXT NOT NULL DEFAULT '',
    approved_at TEXT,
    completed_at TEXT,
    created_at TEXT NOT NULL,
...
`
	...
	for _, migration := range []struct {
		...
		{"workspace_publish_runs", "manual_editor_user_id", "INTEGER NOT NULL DEFAULT 0"},
		{"workspace_publish_runs", "manual_input_message_id", "INTEGER NOT NULL DEFAULT 0"},
		{"workspace_publish_runs", "manual_replacement_run_id", "INTEGER NOT NULL DEFAULT 0"},
