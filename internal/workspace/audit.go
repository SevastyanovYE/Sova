...
func renderTopicPinDrafts() string {
	...
	drafts := []topicDraft{
		...
		{"Опыт", "Проверенные выводы из личного опыта: что сработало, что не сработало, какие правила стоит помнить."},
		{"Полезное", "Готовые полезные материалы, инструкции, списки, маршруты и справки, которые хочется быстро найти позже."},
